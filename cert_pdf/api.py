...
pubkey_list = ['mubib9QNSNfBZkphQb3cCXG6giGKzA9k3X', '15uhtvSU99qqk8rp6BRUX2XgLS9Km7qow9']
...
if __name__ == '__main__':
    ...
    #issue_batch('./PDFs', './output', '15uhtvSU99qqk8rp6BRUX2XgLS9Km7qow9', './configuration/psw_mainnet.txt', 'jxiaaf')
    print(verify_cert('./output/abc-AAA copy 2.json', pubkey_list))